...
![A visual representation of a harness](@assets/images/projects/meta-harness-claude-code/harness-diagram.png)
...
![An illustration of how a harness emits events that an API can consume](@assets/images/projects/meta-harness-claude-code/metaharness-diagram.png)
...
![Screenshot of how i communicate with Claude Code via a web interface](@assets/images/projects/meta-harness-claude-code/new-session.png)
...
![Screenshot of my session's file-diff viewer](@assets/images/projects/meta-harness-claude-code/file-diff-viewer.png)
...
![AI summary widget](@assets/images/projects/meta-harness-claude-code/ai-summary.png)&#x20;

* Tool usage with a nicer user interface

![](@assets/images/projects/meta-harness-claude-code/2026-05-30%20at%2010.30%E2%80%AFPM.png)

* Clicking these links will also open them in my IDE

![](@assets/images/projects/meta-harness-claude-code/2026-05-30%20at%2010.31%E2%80%AFPM.png)

* The ability to attach files or switch claude models

![Ability to add/remove files and choose a model during the session](@assets/images/projects/meta-harness-claude-code/models-and-files.png)

* See estimated token cost, flagging, and archiving sessions

![Showcasing token cost usage](@assets/images/projects/meta-harness-claude-code/token-cost.png)
...
![Changing the model source for a chat](@assets/images/projects/meta-harness-claude-code/changing-model.png)
...
![Dashboard widgets](@assets/images/projects/meta-harness-claude-code/dashboard-widgets.png)
...
![Chat window with my avatar](@assets/images/projects/meta-harness-claude-code/chatting-with-avatar.png)
